...
initRoute : Route.Route -> ( RoutedModel, Cmd Msg )
initRoute route =
    case route of
        Route.Edit flags ->
            Edit.init flags |> fix EditModel (RoutedMsg << EditMsg)

        Route.Show flags ->
            Show.init flags |> fix ShowModel (RoutedMsg << ShowMsg)
